...
const { commentOnPost, createBlog, deleteComment, deletePost, getABlogPost, getAComment, getAllBlogPost, getAllComments, getAllPosts, updateAPost, updateComment } = require('../controller/blog.js');
